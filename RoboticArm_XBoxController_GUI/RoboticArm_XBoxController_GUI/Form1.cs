...
namespace RoboticArm_XBoxController_GUI
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void UpdateControllerValues()
        {
            ...
            /*
             * Need to figure out what changes will be sent to the ugv.
             * define a threshold for the X and Y values of each joystick. If the value is beyond the threshold then
             * a constant value will be sent to be added to the servo that represents that movement its present value
             */
            UpdateTrackBars();
        }
